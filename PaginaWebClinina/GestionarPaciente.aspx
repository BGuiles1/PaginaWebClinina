            ...
            <div class="col-md-6">
                <div class="box box-primary">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <asp:TextBox ID="txtNroDocumento" runat="server" Text="" MaxLength="13" CssClass="form-control formulario__input"></asp:TextBox>
                            <asp:RegularExpressionValidator ID="evDNI" runat="server" ErrorMessage="El DNI solo debe contener 13 digitos y deben ser números" ControlToValidate="txtNroDocumento" ForeColor="#FF3300" ValidationExpression="[0-9]{13}" ValidationGroup="DatosRequeridos"></asp:RegularExpressionValidator>
                        </div>
                        <div class="form-group">
