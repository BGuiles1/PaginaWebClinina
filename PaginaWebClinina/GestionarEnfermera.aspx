                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                          ...
                          <asp:DropDownList ID="ddlTipoEnfermera" runat="server" CssClass="form-control">
                                <asp:ListItem>Técnico(a)</asp:ListItem>
                                <asp:ListItem>Licenciado(a)</asp:ListItem>
                            </asp:DropDownList>  
                         </div>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                <div class="box box-primary">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <asp:TextBox ID="txtTipoEnfermera" runat="server" Text="" CssClass="form-control"></asp:TextBox>
                        </div>
